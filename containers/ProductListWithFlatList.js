...
class ProductListWithFlatList extends Component {
  ...
  onWishTapped = (id, type) => {
    ...
    if(this.props.actionType === 'delete') {
      Alert.alert(
        ...
        [
        {text: 'No', onPress: () => console.log('Not Selected')},
        {text: 'Yes', onPress: () => this.productDelete(id)},
        ],
        { cancelable: false }
        );     
    }
  ...
  productDelete(id) {
    this.props.adminActions.deleteProduct(id);
  }
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    adminActions: bindActionCreators(AdminCreators, dispatch)
  };
}
